        ...
        if (!$error) { ?>
                <main class="container">
                        <div class="bg-body-tertiary p-5 rounded mt-3">
                                ...
                                <p class="lead">Now You Can Login Here</p> <a
                                        class="btn btn-lg btn-primary" href="../app/login.php" role="button">Now You Can Login Here
                                        </a>
                        </div>
                </main>
                <?php
                ...
                <main class="container">
                        <div class="bg-body-tertiary p-5 rounded mt-3">
                                <h1>Signup Failed</h1>
                                <p class="lead">Error: <?php echo $error; ?></p> <a
                                        class="btn btn-lg btn-primary" href="../app/signup.php" role="button">Try Again
                                        </a>
                        </div>
                </main>
<?php
...
<main class="form-signin w-100 m-auto">
        <form method="post" action="signup.php"> <img class="mb-4"
                ...
                <div class="form-floating"> <input name="phone" type="phone" class="form-control" id="floatingInput"
                                placeholder="type username"> <label for="floatingInput">phone</label> </div>
                <div class="form-floating"> <input name="password" type="password" class="form-control"
                                id="floatingPassword" placeholder="Password"> <label
                                for="floatingInput">Password</label> </div>
                <div class="form-check text-start my-3"> <input class="form-check-input" type="checkbox"
                                ...
                                for="checkDefault">
                                Remember me
                        </label> </div> <button class="btn btn-primary w-100 py-2 hvr-box-shadow-inset"
                        type="submit">Signup
                </button>
